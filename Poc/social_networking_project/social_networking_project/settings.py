...
SECRET_KEY = 'django-insecure-g=^3_r*7^q4jv)b@&xb!=x((w3h7lgmk)2tn3n-4h_6xy(_)p='
...
# settings.py
AUTHENTICATION_BACKENDS = ['social_networking_app.authentication.CustomUserAuthenticationBackend']
